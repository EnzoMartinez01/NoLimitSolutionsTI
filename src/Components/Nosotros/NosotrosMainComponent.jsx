                    ...
                    <div className='equipo-fotos-container'>
                        <div className='equipo-fotos'>
                            ...
                            <div className='equipo-fotos-datos'>
                                ...
                                <a href="https://www.linkedin.com/in/anthonylecarnaque/"><i class="fa-brands fa-linkedin"></i></a>
                            </div>
                        </div>
                        <div className='equipo-fotos'>
                            ...
                            <div className='equipo-fotos-datos'>
                                ...
                                <a href="https://www.linkedin.com/in/enzomartinez24/"><i class="fa-brands fa-linkedin"></i></a>
                            </div>
                        </div>
                        <div className='equipo-fotos'>
